...
public abstract class ContainerTagSupport extends BodyTagSupport {
     ...
     * In any case, children can rely upon the container and uiContext being initialized if they
    ...
    public int doStartTag() throws JspException {
        container = ContainerAccess.getContainer(pageContext.getServletContext());
        if (container != null) {
    ...
    protected void startContext(PageContext context) {
        if (container != null) {
            uiContext = container.startContext(pageContext);
        }
    }
