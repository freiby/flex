 ...
 * declaring plug-in's manifest (<code>webplugin.xml</code>) file.
 * <p>
...
public interface IExtension {
	 ...
	 * the manifest (<code>webplugin.xml</code>) file for the plug-in that
	 * declares this extension. Returns an empty array if this extension does
	 * not declare any configuration elements.
	 *
	...
	/**
	 * Returns the unique identifier of the extension point to which this
	 * extension should be contributed.
	 *
	 ...
	 * in the plug-in manifest (<code>webplugin.xml</code>) file as a non-empty
	 ...
	 * is unique within the plug-in registry, and is composed of the namespace
	 * where this extension was declared and this extension's simple identifier.
	 *
