...
public class Plugin implements IPluginDescriptor, IPluginInitializer {
	...
	public Plugin(PluginConfigurationElement configure,
	...
	public String[] getDependencies() {
		if (dependencies == null) {
			IConfigurationElement runtime = configure
					.getChild(PLUGIN_DEPENDENCIES);
			if (runtime == null) {
	 ...
	 * 
	 * @see
	 * com.wxxr.web.platform.core.IPluginDescriptor#getExtension(java.lang.String
	 * )
	 */
	public IExtension getExtension(String extensionName) {
		return registry.getExtension(configure.getNamespaceIndentifier() + "."
				+ extensionName);
	}
	 ...
	 * 
	 * @see
	 * com.wxxr.web.platform.core.IPluginDescriptor#getExtensionPoint(java.lang
	 * .String)
	 */
	public IExtensionPoint getExtensionPoint(String extensionPointId) {
		return registry.getExtensionPoint(configure.getNamespaceIndentifier(),
				extensionPointId);
	}
	 ...
	 * 
	 * @see
	 * com.wxxr.web.platform.core.IPluginDescriptor#getResourceString(java.lang
	 * .String)
	 */
	 ...
	 * @see
	 * com.wxxr.web.platform.core.IPluginDescriptor#getResourceString(java.lang
	 * .String, com.wxxr.common.util.MessageResourceBundle)
	 */
	public String getResourceString(String value,
	...
	public PluginVersionIdentifier getVersionIdentifier() {
		if (versionIdentifier == null) {
			versionIdentifier = new PluginVersionIdentifier(
					configure.getAttribute(PLUGIN_VERSION));
		}
	 ...
	 *            the messageResourceBundle to set
	 */
	public void setMessageResourceBundle(
	...
	protected IPluginInitializer getInitializerDelegate() {
		if ((pluginInitializer == null)
				&& StringUtils.isNotBlank(getInitializerDelegateClass())) {
			try {
				pluginInitializer = (IPluginInitializer) getPluginClassLoader()
						.loadClass(getInitializerDelegateClass()).newInstance();
			} catch (Exception e) {
				throw new CoreException(
						"Failed to create plugin activator for plugin :"
	 ...
	 * 
	 * @see
	 * com.wxxr.web.platform.core.IPluginDescriptor#getConfigurationElement()
	 */
