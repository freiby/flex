 ...
 * obtained from the declaring plug-in's manifest (<code>webplugin.xml</code>)
 * file.
 * <p>
...
public interface IExtensionPoint {
	 ...
	 * is guaranteed to be unique within the namespace.
	 *
	 ...
	 * unique within the plug-in registry, and is composed of the namespace for
