...
public interface IExtensionRegistry {
	 ...
	 * the XML file should be supplied in the same format as the webplugin.xml; in fact,
	 ...
	 * point(s) or/and extension(s) described in the format similar to webplugin.xml. The method
	 ...
	 * 	otherwise
	 * @throws IllegalArgumentException if an parameter is passed
	 * 
	 * @see IContributor
	 */
	public boolean addContribution(Object source, IContributor contributor, String name, MessageResourceBundle translationBundle) ;
	 ...
	 * @throws IllegalArgumentException if an incorrect extension is passed
	 * 
	 */
	public boolean removeExtension(IExtension extension) throws IllegalArgumentException;
