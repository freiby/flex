...
public class ExtensionDelta implements IExtensionDelta {
  ...
  public ExtensionDelta(IExtension ext,int kind){
    if((ext == null)||((kind != IExtensionDelta.ADDED)&&(kind != IExtensionDelta.REMOVED))){
  ...
  public ExtensionDelta(IExtensionPoint extp,int kind){
    if((extp == null)||((kind != IExtensionDelta.ADDED)&&(kind != IExtensionDelta.REMOVED))){
      throw new IllegalArgumentException();
    }
    this.extObject = extp;
    this.kind = kind;
  ...
  public IExtension getExtension() {
    return (extObject instanceof IExtension) ? (IExtension)extObject : null;
  }
  ...
  public IExtensionPoint getExtensionPoint() {
    return (extObject instanceof IExtensionPoint) ? (IExtensionPoint)extObject : null;
  }
