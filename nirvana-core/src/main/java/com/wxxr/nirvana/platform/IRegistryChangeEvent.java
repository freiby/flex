...
public interface IRegistryChangeEvent {
	/**
	 * Returns all extension deltas for all hosts. Returns an empty array if
	 * there are no deltas in this event.
	 * 
	...
	/**
	 * Returns all extension deltas for the given namespace. Returns an empty
	 * array if there are no deltas in this event for any extension points
	 * provided in the given namespace.
	 * 
	 * @param namespace
	 ...
	 * point. Returns an empty array if there are no deltas in this event for
