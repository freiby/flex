...
//    private StringBuffer buf = new StringBuffer();
    ...
    public String getFullPath() {
      ...
      for (wrapper = this; wrapper != null; wrapper = (HandlerWrapper)wrapper.getParentNode()) {
      ...
      return buf.toString();
        ...
        /* (non-Javadoc)
         * @see com.hygensoft.framework.common.configuration.xmlparser.IConfigureElementParser#setContents(java.lang.String)
         */
