...
public interface CoreConstants {
  ...
  public static final String PLUGIN_DEPEND = "requires"; //$NON-NLS-1$
  ...
  public static final String LABEL_NAME = "label"; //$NON-NLS-1$

  public static final String PLUGIN_XML = "webplugin.xml";
  
  public static final String ATT_FILTER = "filter";
  public static final String ATT_BLACKLIST = "blacklist";
