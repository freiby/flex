...
public interface IPlatform {
	 ...
	 * platform, or <code>null</code> if there is no such plug-in. If there are
	 * multiple versions of the identified plug-in, one will be
	...
	/**
	 * Returns all plug-in descriptors known to this platform. Returns an empty
	 * array if there are no installed plug-ins.
	 *
	...
	/**
	 * deploy plugin from specific location, where a jar file or a folder
	 * contains all related resource resides
	 * 
	 * added at 2007-10-25
	 * 
	 * @param packageURL
	...
	/**
	 * undeploy all version of plugin specified by pluginId if version is not
	 * specified. or undeploy specific version of plugin if version is
	 * presented. added at 2007-10-25
	 * 
	 * @param pluginId
	 * @param version
	 * @throws CoreException
	...
	/**
	 * return the latest version number of plugin which deployed in this
	 * platform added at 2007-10-25
	 * 
	 * @param pluginId
	 * @return
	 */
	...
	/**
	 * check if specific plugin is deployed if version is not presented check if
	 * specific version of plugin is deployed if version is presented added at
	 * 2007-10-25
	 * 
	 * @param pluginId
	 * @param version
	...
	/**
	 * activate specific version of deployed plugin, or activate latest version
	 * of deployed plugin if version is not presented. added at 2007-10-27
	 * 
	 * @param pluginId
	 * @param version
	 * @throws CoreException
	...
	/**
	 * deactivate currently activated plugin added at 2007-10-27
	 * 
	 * @param pluginId
	 * @param version
	 * @throws CoreException
