 ...
 * obtained from the plug-in's manifest (<code>webplugin.xml</code>) file.
 * <p>
...
public interface IPluginDescriptor {
	 ...
	 * strings used in the plug-in manifest file (<code>webplugin.xml</code>)
	 * along with other resource strings used by the plug-in implementation.
	 * </p>
	 *
	 * @return the message resource , null if the message resource is not existing
	 */
	 ...
	 * @see #getMessageResource()
	 */
	public String getResourceString(String value, MessageResourceBundle resourceBundle);
