...
public class PermissionsManager extends BaseExtensionPointManager implements
	...
	protected IPermissionDescriptor createNewPermission(
			IConfigurationElement elem) throws Exception {
		...
		if (StringUtils.isBlank(clazz)) {
			...
			permission = (IPermissionDescriptor) createPluginObject(clazz,
					plugin);
		}
	...
	protected void processExtensionRemoved(IExtension ext) {
		...
		for (int i = 0; i < ids.length; i++) {
			String id = ids[i];
			IPermissionDescriptor per = removePermission(
	 ...
	 * 
	 * @see
	 * com.wxxr.web.ui.permissions.IPermissionsManager#addPermission(com.wxxr
	 * .web.ui.permissions.IPermissionDescriptor)
	 */
	public void addPermission(IPermissionDescriptor permission) {
		...
		synchronized (permissions) {
			Map<String, IPermissionDescriptor> map = permissions.get(permission
					.getContributorId());
			if (map == null) {
	 ...
	 * 
	 * @see
	 * com.wxxr.web.ui.permissions.IPermissionsManager#getAllPermissionIds()
	 */
	 ...
	 * 
	 * @see
	 * com.wxxr.web.ui.permissions.IPermissionsManager#getDefaultPermission()
	 */
	 ...
	 * 
	 * @see
	 * com.wxxr.web.ui.permissions.IPermissionsManager#getPermission(java.lang
	 * .String)
	 */
	 ...
	 * 
	 * @see
	 * com.wxxr.web.ui.permissions.IPermissionsManager#removePermission(java
	 * .lang.String)
	 */
	public IPermissionDescriptor removePermission(String namespace,
			String targetId) {
		synchronized (permissions) {
			if (permissions.isEmpty()) {
				return null;
