...
public interface IConfigurationElement {
	 ...
	 * value must contain a fully qualified name of a Java class. The class can
	 * either refer to a class implementing the executable extension or to a
	 * factory capable of returning the executable extension.
	 * <p>
	 ...
	 * is called, passing to the object the configuration information that was
	 * used to create it.
	 * <p>
	...
	/**
	 * Returns id of the extension that declares this configuration element.
	 *
	...
	/**
	 * Returns whether this configuration element has attribute "name".
	 * 
	 * @return <code>true</code> if has the attribute, and <code>false</code> if
	 *         it has not
	 */
