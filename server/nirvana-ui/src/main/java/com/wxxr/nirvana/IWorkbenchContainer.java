...
public interface IWorkbenchContainer extends IContainer {
	 ...
	 */
	void bootstrap(HttpServletRequest request, HttpServletResponse response,
			String product, String page) throws NirvanaException;
	 ...
	 * @throws NirvanaException
	 */
	void render(String component, PageContext context,
