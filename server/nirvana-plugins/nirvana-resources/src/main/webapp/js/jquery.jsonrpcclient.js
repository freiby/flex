...
(function($) {
   ...
   */
  JsonRpcClient.prototype.call = function(method, params, rpcId, successCb, errorCb) {
   ...
   */
  JsonRpcClient._batchObject.prototype.call = function(method, params, rpcId, successCb, errorCb) {
    this._requests.push({
      request    : {
        jsonrpc : '2.0',
        method  : method,
        params  : params,
        id      : this.jsonrpcclient._currentId++, // Increase the id counter to match request/response
        rpcId   : rpcId //add by fudapeng
      },
      successCb : successCb,
      errorCb   : errorCb
